...
namespace Illuminate\Support\Facades {
    ...
    class App {
        /**
         * @return \Pin\Bootstrap\ApplicationBuilder
         * @static
         */
        public static function configure($basePath = null)
        {
            return \Pin\Application::configure($basePath);
        }
         ...
         * @static
         */
        public static function loadedConfiguration()
        {
            /** @var \Pin\Application $instance */
            return $instance->loadedConfiguration();
        }
         ...
         * @static
         */
        public static function runningInHttp()
        {
            /** @var \Pin\Application $instance */
            return $instance->runningInHttp();
        }
        ...
        public static function inferBasePath()
        {
            ...
            return \Pin\Application::inferBasePath();
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Application 
            \Pin\Application::macro($name, $macro);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Application 
            \Pin\Application::mixin($mixin, $replace);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Application 
            return \Pin\Application::hasMacro($name);
        }
        ...
        {
            //Method inherited from \Illuminate\Container\Container 
            return \Pin\Application::getInstance();
        }
        ...
        {
            //Method inherited from \Illuminate\Container\Container 
            return \Pin\Application::setInstance($container);
        }
    ...
    class Request {
        ...
        /**
         * @see \Pin\Http\Request::registerMacros()
         * @param mixed $parameters
         * @static
         */
        public static function getReferer(...$parameters)
        {
            return \Illuminate\Http\Request::getReferer(...$parameters);
        }
         ...
         * @static
         */
        public static function isFromApiDocument(...$parameters)
        {
            return \Illuminate\Http\Request::isFromApiDocument(...$parameters);
        }
         ...
         * @static
         */
        public static function isReading(...$parameters)
        {
            return \Illuminate\Http\Request::isReading(...$parameters);
        }
         ...
         * @static
         */
        public static function isRequest(...$parameters)
        {
            return \Illuminate\Http\Request::isRequest(...$parameters);
        }
...
namespace  {
    ...
    class Eloquent extends \Illuminate\Database\Eloquent\Model {        /**
        ...
        /**
         * @see \Pin\Models\Scopes\Aggregate::addSelectAvg()
         * @param string $column
         * @param string|null $alias
         * @static
         */
        public static function addSelectAvg($column, $alias = null)
        {
            return \Illuminate\Database\Eloquent\Builder::addSelectAvg($column, $alias);
        }

        /**
         * @see \Pin\Models\Scopes\Aggregate::addSelectCount()
         * @param string $column
         * @param string $alias
         * @static
         */
        public static function addSelectCount($column = '*', $alias = 'total')
        {
            return \Illuminate\Database\Eloquent\Builder::addSelectCount($column, $alias);
        }

        /**
         * @see \Pin\Models\Scopes\Aggregate::addSelectMax()
         * @param string $column
         * @param string|null $alias
         * @static
         */
        public static function addSelectMax($column, $alias = null)
        {
            return \Illuminate\Database\Eloquent\Builder::addSelectMax($column, $alias);
        }

        /**
         * @see \Pin\Models\Scopes\Aggregate::addSelectMin()
         * @param string $column
         * @param string|null $alias
         * @static
         */
        public static function addSelectMin($column, $alias = null)
        {
            return \Illuminate\Database\Eloquent\Builder::addSelectMin($column, $alias);
        }

        /**
         * @see \Pin\Models\Scopes\Aggregate::addSelectSum()
         * @param string $column
         * @param string|null $alias
         * @static
         */
        public static function addSelectSum($column, $alias = null)
        {
            return \Illuminate\Database\Eloquent\Builder::addSelectSum($column, $alias);
        }

        /**
         * @see \Pin\Models\Scopes\Pagination::pagination()
         * @param int|null $page
         * @param int|null $pageSize
         * @param array $columns
         * @static
         */
        public static function pagination($page = null, $pageSize = null, $columns = [])
        {
            return \Illuminate\Database\Eloquent\Builder::pagination($page, $pageSize, $columns);
        }

        /**
         * @see \Pin\Models\Queryable\QueryableScope::queryable()
         * @param \Pin\Models\Queryable\Queryable|\Pin\Models\Queryable\QueryableCondition|array|null $queryable
         * @static
         */
        public static function queryable($queryable)
        {
            return \Illuminate\Database\Eloquent\Builder::queryable($queryable);
        }

        /**
         * @see \Pin\Models\Scopes\Sort::sort()
         * @param array|string|null $value
         * @param array|string $allows
         * @static
         */
        public static function sort($value, $allows)
        {
            return \Illuminate\Database\Eloquent\Builder::sort($value, $allows);
        }
